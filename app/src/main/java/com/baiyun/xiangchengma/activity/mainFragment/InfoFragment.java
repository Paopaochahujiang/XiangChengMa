...
import com.baiyun.xiangchengma.activity.mainFragment.frgmentInfo.BlueToothFragment;
import com.baiyun.xiangchengma.activity.mainFragment.frgmentInfo.InfoQueryFragment;
import com.baiyun.xiangchengma.activity.mainFragment.frgmentInfo.InfoReportFragment;
import com.baiyun.xiangchengma.adapter.MyFragmentPagerAdapter;
...
public class InfoFragment extends Fragment implements View.OnClickListener{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mList.add(new BlueToothFragment());
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment1_mapinfo,container,false);
    }

    TextView home_textView;
    TextView query_textView;
    TextView bluetooth_View;
    ...
    public void onViewCreated(View view,Bundle savedInstanceState){
        ...
        bluetooth_View=(TextView)view.findViewById(R.id.blue_tooth_query);
        ...
        bluetooth_View.setOnClickListener(this);
    ...
    private void changeTextColor(int position){
        if(position==0){
            ...
            bluetooth_View.setTextColor(Color.parseColor("#696969"));
        }else if(position==1) {
            ...
            bluetooth_View.setTextColor(Color.parseColor("#d42517"));
            home_textView.setTextColor(Color.parseColor("#696969"));
            query_textView.setTextColor(Color.parseColor("#696969"));
        }
    }
