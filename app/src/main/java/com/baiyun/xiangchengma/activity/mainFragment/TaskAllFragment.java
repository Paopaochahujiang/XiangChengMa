...
import com.baiyun.xiangchengma.activity.mainFragment.locationFragment.MenoFragment;
import com.baiyun.xiangchengma.activity.mainFragment.locationFragment.TaskFragment;
...
public class TaskAllFragment extends Fragment implements View.OnClickListener {  // implements View.OnClickListener
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment1_locationall, container, false);
        return view;
    }
